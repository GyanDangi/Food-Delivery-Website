...
//Order Collection
// var Detail1 = require('./authentication/app/models/orderDB');
...
// require('./back_end/food_info.js')(express, app, multer, bodyParser,path, Detail1);
...
// launch ======================================================================
app.listen(port);
console.log('Fresh Food Oder System on port ' + port);